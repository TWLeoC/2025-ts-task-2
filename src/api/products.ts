...
import type { CreateProductParams, CreateProductResponse, GetProductsResponse, EditProductResponse, DeleteProductResponse, EditProductParams, UploadImageResponse } from '@/types/product'
